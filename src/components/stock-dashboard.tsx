...
import { StockPieChart } from "@/components/stock-pie-chart";
...
export function StockDashboard({ data, config }: Props) {
    ...
    <>
      ...
      <div className="row g-3 mb-4">
        <div className="col-12 col-lg-6">
          <StockPieChart holdings={viewHoldings} />
        </div>
        <div className="col-12 col-lg-6">
          <LabelAllocationChart holdings={viewHoldings} labelMap={labelMap} />
        </div>
      </div>
